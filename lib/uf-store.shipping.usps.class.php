...
class UFStoreShippingUSPS{

	public static function usps($package, $country, $shipping_to){		
		...
		//Create package
		$package = UFStoreShippingUSPS::usps_create_package($package, $country, $shipping_to, $shipping_from);

		//Execute CURL
		$response = UFStoreShippingUSPS::execute_curl($api_url.$package);

		//Sort through it
		$shipping_options = UFStoreShippingUSPS::parse_response_xml($response, $country);

		return $shipping_options;
	}


	public static function usps_create_package($package, $country, $shipping_to, $shipping_from){
		$package_string = '';
	...
	public static function execute_curl($url){
		$errors = array();
		$curl = curl_init();
	...
	public static function parse_response_xml($response, $country){
